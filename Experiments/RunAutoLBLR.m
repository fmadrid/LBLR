...
DATASET       = '../../Datasets/Behaviors/EpilepsyEpisodeRecognition.mat';  
OUTPUT_FOLDER = 'Sample';            % Outputs all results to this directory
...
fileID = fopen([OUTPUT_FOLDER '/Experiment Results.txt']);
...
clear DATASET OUTPUT_FOLDER SAVEPLOTS MODEL_LENGTH BITS BLIND errormsg ElapsedtimeAutoLBLR